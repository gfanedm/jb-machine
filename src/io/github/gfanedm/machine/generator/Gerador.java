...
public class Gerador {
	...
	static final int HAULT = -1; // OPCIDE que representa o final do seu programa -> A ultima instrucao FOR
									// contera essE OPCODE
	static final int TAM_FOR = 10; // Tamanho dos blocos
	static final int REPETICOES = 70; // (0 <= REPETICOES <= 100) Porcentagem que representa a quantidade de blocos de
										// FOR repetidos dentro do NUM_INS
	// O mesmo bloco (FOR) aparecera "REPETICOES(%)" da quantidade total de blocos
	// (FORs), nao necessariamente em sequencia.
	static final int TAM_MEM = 51200; // Tamanho da RAM
	...
	// 1: -> IMPRIME O ENDERECO DA PALAVRA (0 A 3) APOS --- CADA --- ENDERECO DE
	// BLOCO (ATE TAM_RAM-1) vide instrucoes.txt
	// 0: -> IMPRIME APENAS O ENDERECO DE BLOCOS

	/*
	 * OBSERVACOES:
	 * 
	 * . Defina o INTERVALO DE OPCODES das suas instrucoes em "op_min" e "op_max". A
	 * instrucao "x" gerada sera "op_min <= x <= op_max"... ...se assegure que seu
	 * "hault" nao se encontra nesse intervalo.
	 * 
	 * . A quantidade de instrucoes e' funcao da divisao inteira NUM_INS / TAM_FOR.
	 * 
	 * . Este codigo gerara' um arquivo no formato ".txt" com o nome
	 * "instrucoes.txt".
	 * 
	 * . Em "instrucoes.txt", nao ha espacos apos o ultimo numero de cada linha, nem
	 * antes do primeiro... ...portanto, nao ha' problemas, p. ex., com duplos
	 * inputs em variaveis do tipo "istringstream", entre outros erros.
	 * 
	 */
